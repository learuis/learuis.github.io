...
The reality of playing in a shared online environment is that we have a collective responsibility to make the server an
enjoyable experience for each other. The following rules are intended to ensure an equitable experience for all players
while reducing server lag.

### 2.1 - BUILDING LOCATION

You can build anywhere on the map that the game allows but do not build close to other players without permission. Get
permission from the owner of the existing base or look for somewhere else to build. This can be checked with a
...
Do not "wall in" resources or block access to them. Do not block the spawn locations of world bosses, animal cubs, or
horses. Do not block throughways, paths, or cave entrances. If you build on an important throughway you must provide
passage through or around your base.
...
The server is a shared space and excessively large / laggy bases are problematic for the entire community. Be proactive
and consider performance around your base. Bases that cause significant drops in FPS for other players may need to be
altered. While measurement tools for this are limited, the moderator team reserves the right to make rulings based on
the best interests of the entire server.

### 2.7 - PUT EFFORT INTO YOUR BUILDS

Help make the server look nice! Put some effort into your buildings and be creative. Do not build giant sandstone cubes.
